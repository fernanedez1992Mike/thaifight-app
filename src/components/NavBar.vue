...
<div id="nav">
  <b-nav>
    ...
    <b-nav-item-dropdown
      text="Articles"
    >
      <b-dropdown-item><router-link :to="{name: 'article'}">Articles</router-link></b-dropdown-item>
      <b-dropdown-item><router-link :to="{name: 'articleEdit'}">Article-edit</router-link></b-dropdown-item>
    </b-nav-item-dropdown>
  </b-nav>
</div>
